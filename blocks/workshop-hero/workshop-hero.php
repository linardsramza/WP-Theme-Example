...
$certificates = wp_get_post_terms( $w_id, 'workshops-certificates');

$hide_rating = get_field('hide_rating', $w_id) ?? false;
$rating = get_field('average_rating', $w_id) ?? 0;
...
get_template_part(
	...
	array(
		...
		'phone' => $phone,
		'email' => $email,
		'link_to_booking' => $link_to_booking,
